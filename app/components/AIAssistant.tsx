...
export default function AIAssistant() {
  ...
  const saveKey = (key: string) => {
    setApiKey(key);
    localStorage.setItem("frost_ai_key", key);
  ...
  const send = async (text?: string) => {
    ...
    try {
      ...
      setError(e.message || "Error. Check your API key.");
    } finally {
      setLoading(false);
    }
  };
          ...
          <div className="ai-panel-header">
            <div className="ai-panel-title">
              ...
              <div>
                ...
                <div className="ai-panel-sub">Trading Assistant</div>
              </div>
            </div>
            ...
            <div className="ai-key-box">
              ...
              <div className="ai-key-row">
                ...
                <button
                  ...
                  onClick={() => {
                    const val = (document.getElementById("ai-key-field") as HTMLInputElement)?.value;
                    if (val) saveKey(val);
                  }}
                >
                  Save
